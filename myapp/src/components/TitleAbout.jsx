    ...
    <div className="bg-white mt-10 px-4 sm:px-[5vw] md:px-[6vw] lg:px-[9vw]">
      ...
      <div className="flex flex-col lg:flex-row-reverse items-center justify-between gap-4 md:gap-6 lg:gap-8">
        ...
        <motion.div
          ...
          className="relative w-full lg:w-1/2 flex items-center justify-center py-4 md:py-4 lg:py-6"
        >
        ...
        >
          <h3 className="text-2xl lg:text-5xl sm:text-3xl md:text-4xl mb-3 text-[#023E8A] font-poppins leading-tight md:leading-snug">
            Committed to Care
          </h3>

          <p className="font-opensans mb-3 sm:text-base lg:text-lg leading-relaxed text-left lg:text-justify">
          ...
          <p className="font-opensans sm:text-base lg:text-lg leading-relaxed text-left lg:text-justify">
