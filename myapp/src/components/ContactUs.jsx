  ...
  return (
    <div className="relative w-full bg-gray-100 ">
      ...
      <div className="relative w-full h-[450px] sm:h-[550px] lg:h-[650px]">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-start pt-16 sm:pt-20 lg:pt-28 text-center px-6">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white">
            Book Your Appointment
          </h1>
          <p className="mt-2 sm:mt-3 text-sm sm:text-base text-white max-w-lg">
      ...
      <div className="absolute left-1/2 transform -translate-x-1/2 -bottom-20 w-11/12 sm:w-4/5 md:w-3/4 lg:w-2/3 bg-white rounded-3xl shadow-2xl px-8 sm:px-12 py-12 sm:py-16">
        ...
        <form className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <button
            type="submit"
            className="sm:col-span-2 w-full bg-[#023E8A] text-white py-3 sm:py-4 rounded-lg font-medium hover:bg-blue-700 transition"
          >
            Submit
          </button>
        </form>
